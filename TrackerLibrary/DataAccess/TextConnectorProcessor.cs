...
namespace TrackerLibrary.DataAccess.TextHelpers
{
    public static class TextConnectorProcessor
    {
            ...
            string PrizeFileName)
        {
            ...
            List<MatchupModel> matchups = GlobalConfig.MatchFile.FullFilePath().LoadFile().ConvertToMatchupModel();
        ...
        public static void SaveRoundsToFile(this TournamentModel models, string matchupFile, string matchupEntryFile)
        {
            ...
            // Get the id for the new matchup and save the recoed
        ...
        private static List<MatchEntryModel> ConvertStringToMatchupEntryModels(string input)
        {
        ...
        private static MatchupModel LookUpTeamMatchById(int id)
        {
            List<string> matchups = GlobalConfig.MatchFile.FullFilePath().LoadFile();
        ...
        public static void SaveMatchupToFile(this MatchupModel matchup, string matchupFile, string matchupEntryFile)
        {
            ...
            File.WriteAllLines(GlobalConfig.MatchFile.FullFilePath(), lines);
        }
        ...
        private static string ConvertMatchupEntryListToString(List<MatchEntryModel> entries)
        {
            string output = "";
